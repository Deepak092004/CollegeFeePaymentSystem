...
<head>
    ...
    <meta name="description" content="Add a new fee payment in the College Fee Payment System">
    ...
    <div class="split-container">
        ...
        <div class="right-panel">
            ...
            <% if (request.getParameter("error") != null) { %>
                <div class="alert alert-danger">Failed to add payment. Please try again.</div>
            <% } %>
